...
class InstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrument" do
    assert_difference("Instrument.count") do
      post instruments_url, params: { instrument: { company_id: @instrument.company_id, images: @instrument.images, name: @instrument.name, price: @instrument.price, price_currency: @instrument.price_currency, state: @instrument.state } }
    end
  ...
  test "should update instrument" do
    patch instrument_url(@instrument), params: { instrument: { company_id: @instrument.company_id, images: @instrument.images, name: @instrument.name, price: @instrument.price, price_currency: @instrument.price_currency, state: @instrument.state } }
